 ...
 */
final class Version20241219071704 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD account_status VARCHAR(255) DEFAULT \'inactive\' NOT NULL, ADD roles LONGTEXT DEFAULT \'["ROLE_USER"]\' NOT NULL COMMENT \'(DC2Type:json)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` DROP account_status, DROP roles');
    }
}

...
class Users
{
    ...
    #[ORM\Column]
    private ?int $current_subscription_id = null;
    ...
    public function getCurrentSubscriptionId(): ?int
    {
        return $this->current_subscription_id;
    }

    public function setCurrentSubscriptionId(int $current_subscription_id): static
    {
